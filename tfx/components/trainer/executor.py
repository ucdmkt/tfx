...
class Executor(base_executor.BaseExecutor):
  ...
  def Do(self, input_dict: Dict[Text, List[types.Artifact]],
    ...
    base_models = [
        path_utils.serving_model_path(a.uri) for a in input_dict['base_models']
    ] if 'base_models' in input_dict else []
    ...
    train_fn_args = _TrainerFnArgs(
        ...
        # Base models that will be used for this training job.
